...
class TrajectronEWTA(Trajectron):
    ...
    def encoding(self,batch,node_type,device=None):
        (first_history_index,
         x_t, y_t, x_st_t, y_st_t,
         neighbors_data_st,
         neighbors_edge_value,
    ...
    def vis_encoding(self,batch,node_type,device=None,return_feat=True):
        (first_history_index,
         x_t, y_t, x_st_t, y_st_t,
         neighbors_data_st,
         neighbors_edge_value,
        ...
        predictions, features,original_features = model.predict(
            ...
            robot=robot_traj_st_t,
            map=map,
            prediction_horizon=self.ph,return_original=True,return_feat=return_feat)
        # predictions = predictions.permute(1, 0, 2, 3)
