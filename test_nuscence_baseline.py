...
from Trajectron_plus_plus.trajectron.model.mgcvaeEWTA import model_encdec
# from Trajectron_plus_plus.trajectron.model.mgcvaeEWTA_hyper import model_encdec_re
...
def parse_arguments():
    ...
    parser.add_argument("--model", help="model full path", type=str,
                        # default='./models/nuScenes_model/trajectron_map_int_ewta')
                        default='./models/nuScenes_contrastive')
    ...
    parser.add_argument("--baseline_error", type=str, 
                        ...
                        # default='/data2/wyn/Contrastive-Future-Trajectory-Prediction-main/kalman/nuScenes_VEHICLE_test_kalman.pkl')
                        # default='/data2/wyn/Contrastive-Future-Trajectory-Prediction-main/kalman/nuScenes_VEHICLE_test.pkl')
