...
def process_data(data_path, version, output_path, val_split):
    ...
    ns_scene_names['train'] = train_scenes
    ...
    for data_class in ['train', 'val', 'test']:
        ...
        if len(scenes) > 0:
            ...
            # data_dict_path = os.path.join(output_path, 'nuScenes_' + data_class + mini_string + '_split.pkl')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='/data2/wyn/Nuscenes')
    parser.add_argument('--version', type=str, default='v1.0-trainval')
    parser.add_argument('--output_path', type=str, default='Trajectron_plus_plus/experiments/processed')
