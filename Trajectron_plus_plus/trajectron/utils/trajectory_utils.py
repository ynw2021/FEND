...
def prediction_output_to_trajectories_nll(prediction_output_dict,
                                      dt,
                                      max_h,
                                      ph,
                                      map=None,
    ...
    for t in prediction_timesteps:
        ...
        for node in prediction_nodes:
            ...
            if prune_ph_to_future:
                p0,p1,p2,p3=predictions_output
                predictions_output = [p0[ :, :future.shape[0]],p1[ :, :future.shape[0]],p2[ :, :future.shape[0]],p3 ]
                if predictions_output[0].shape[2] == 0:
                    continue
