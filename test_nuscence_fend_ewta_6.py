...
def parse_arguments():
    ...
    parser.add_argument("--model", help="model full path", type=str,
                        default='./models/nuScenes_model/trajectron_map_int_hyperre_warmup15_justlongtail_fullrecaug_0.2_[1,0.2]_v_[5,12,25]_withoutfrequency_mlp')
    ...
    parser.add_argument("--baseline_error", type=str, 
                        default='./kalman/nuScenes_VEHICLE_test_ewta_6.pkl')
